...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO reservasi (id_reservasi, nama_tamu, jumlah_tamu, jumlah_hari, tipe_kamar, tgl_reservasi, tgl_check_in, tgl_check_out, harga, id_resepsionis, no_kamar, id_tamu) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['id_reservasi'], "text"),
                       GetSQLValueString($_POST['nama_tamu'], "text"),
                       GetSQLValueString($_POST['jumlah_tamu'], "text"),
                       GetSQLValueString($_POST['jumlah_hari'], "text"),
                       ...
                       GetSQLValueString($_POST['no_kamar'], "text"),
...
mysql_select_db($database_hotel1, $hotel1);
$query_home = "SELECT * FROM reservasi";
$home = mysql_query($query_home, $hotel1) or die(mysql_error());
...
<table width="1124" height="561" border="1" align="center">
  ...
  <tr>
    <td height="416" colspan="3"><ul id="MenuBar1" class="MenuBarHorizontal">
      ...
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>Silahkan Reservasi Dibawah   </p>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          ...
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">No_kamar:</td>
            <td><input type="text" name="no_kamar" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
