...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE kamar SET keterangankamar=%s WHERE kamarspesial=%s",
  ...
  $updateGoTo = "kamarhoteladmin.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_hotel1, $hotel1);
$query_kamaredit = "SELECT * FROM kamar";
$kamaredit = mysql_query($query_kamaredit, $hotel1) or die(mysql_error());
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            ...
            <td><?php echo $row_kamaredit['kamarspesial']; ?></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Keterangankamar:</td>
            <td><input type="text" name="keterangankamar" value="<?php echo htmlentities($row_kamaredit['keterangankamar'], ENT_COMPAT, 'utf-8'); ?>" size="32" /></td>
          </tr>
          <tr valign="baseline">
        ...
        <input type="hidden" name="kamarspesial" value="<?php echo $row_kamaredit['kamarspesial']; ?>" />
      </form>
      <p>&nbsp;</p>
