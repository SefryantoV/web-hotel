...
$totalRows_tamu = mysql_num_rows($tamu);$colname_tamu = "-1";
if (isset($_GET['nama'])) {
  $colname_tamu = $_GET['nama'];
}
mysql_select_db($database_hotel1, $hotel1);
$query_tamu = sprintf("SELECT * FROM tamu WHERE nama_tamu = %s", GetSQLValueString($colname_tamu, "text"));
$tamu = mysql_query($query_tamu, $hotel1) or die(mysql_error());
$row_tamu = mysql_fetch_assoc($tamu);
